...
path = base + '/src/runtime/runtime.js'

new_content = '''import BrowserRuntime from "./browser/browserRuntime.js";
...
print('Done — src/runtime/runtime.js updated with all Phase 2 controls + SCORM')
